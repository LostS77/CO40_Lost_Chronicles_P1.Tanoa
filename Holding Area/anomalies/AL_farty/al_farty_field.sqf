...
_obj_tox setObjectTextureGlobal [0,"modules\anomalies\AL_farty\04_lake.paa"];
_obj_tox setDir (random 360);
_obj_tox allowDamage false;

[_toxic_center,_radius_toxic,_damage_toxic] execvm "modules\anomalies\AL_farty\damage_toxic_field.sqf";
