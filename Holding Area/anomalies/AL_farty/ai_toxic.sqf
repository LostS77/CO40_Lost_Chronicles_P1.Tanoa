//by ALIAS
//["myfarty",1,50] execvm "modules\anomalies\AL_farty\ai_toxic.sqf";
...
while {true} do 
{
	...
	if (count _list_ai_in_range_tox>0) then 
	{
		...
		[[_x,_location_mark,_damage_toxic,_radius_toxic],"modules\anomalies\AL_farty\ai_action.sqf"] remoteExec ["execvm"];
		};
