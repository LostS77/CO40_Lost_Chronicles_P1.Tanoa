...
*/
["farty_1","H_PilotHelmetFighter_B",true,80,0.05,true,20] execVM "modules\anomalies\AL_farty\area_toxic_ini.sqf";
["farty_2","H_PilotHelmetFighter_B",true,50,0.05,true,7] execVM "modules\anomalies\AL_farty\area_toxic_ini.sqf";
["farty_3","H_PilotHelmetFighter_B",true,50,0.05,true,7] execVM "modules\anomalies\AL_farty\area_toxic_ini.sqf";
["farty_4","H_PilotHelmetFighter_B",true,50,0.05,true,7] execVM "modules\anomalies\AL_farty\area_toxic_ini.sqf";
["farty_5","H_PilotHelmetFighter_B",true,50,0.05,true,7] execVM "modules\anomalies\AL_farty\area_toxic_ini.sqf";
["farty_6","H_PilotHelmetFighter_B",true,50,0.05,true,7] execVM "modules\anomalies\AL_farty\area_toxic_ini.sqf";