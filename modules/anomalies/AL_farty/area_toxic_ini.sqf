...
fnc_create_puddle = {
	...
	_img_puddle	=["modules\anomalies\AL_farty\01_lake.paa","modules\anomalies\AL_farty\02_lake.paa","modules\anomalies\AL_farty\03_lake.paa","modules\anomalies\AL_farty\04_lake.paa"] call BIS_fnc_selectRandom;
	...
	if (_sfx_puddle) then {[[_obj_puddle],"modules\anomalies\AL_farty\toxic_puddle.sqf"] remoteExec ["execVM",0,true]}
};
...
fnc_puddle_trail = {
	...
	_aspect_puddle = ["modules\anomalies\AL_farty\01_lake.paa","modules\anomalies\AL_farty\02_lake.paa","modules\anomalies\AL_farty\03_lake.paa","modules\anomalies\AL_farty\04_lake.paa"] call BIS_fnc_selectRandom;
...
[[_location_mark,_radius_toxic,_damage_toxic,_anomalyVSfield,_farty_loc],"modules\anomalies\AL_farty\al_farty_field.sqf"] remoteExec ["execVM",0,true];

[_location_mark,_damage_toxic,_radius_toxic] execvm "modules\anomalies\AL_farty\ai_toxic.sqf";
...
for "_i" from 0 to 5 do {_farty_boss setObjectTextureGlobal [_i,"modules\anomalies\AL_farty\02_lake.paa"]};
...
{_carcasa = "Sign_Sphere200cm_F" createVehicle [0,0,0];_carcasa setObjectMaterialglobal [0, "a3\characters_f_bootcamp\common\data\vrarmoremmisive.rvmat"];	_carcasa setObjectTextureGlobal [0,"modules\anomalies\AL_farty\images\shell.jpg"];	_carcasa setdir (random 360);	_comp_obj_casp pushBack _carcasa;	_carcasa attachTo [_farty_boss, [0,0,0],_x]} forEach _pct_farty;

_cap_segment = "Sign_Sphere200cm_F" createVehicle [0,0,0];_cap_segment setObjectMaterialglobal [0, "a3\characters_f_bootcamp\common\data\vrarmoremmisive.rvmat"];_cap_segment setObjectTextureGlobal [0,"modules\anomalies\AL_farty\images\shell.jpg"];
_carcasa_coada = "Sign_Sphere200cm_F" createVehicle [0,0,0];_carcasa_coada setObjectMaterialglobal [0, "a3\characters_f_bootcamp\common\data\vrarmoremmisive.rvmat"];_carcasa_coada setObjectTextureGlobal [0,"modules\anomalies\AL_farty\images\shell.jpg"];
_carcasa_coada_1 = "Sign_Sphere200cm_F" createVehicle [0,0,0];_carcasa_coada_1 setObjectMaterialglobal [0, "a3\characters_f_bootcamp\common\data\vrarmoremmisive.rvmat"];_carcasa_coada_1 setObjectTextureGlobal [0,"modules\anomalies\AL_farty\images\shell.jpg"];
_carcasa_coada_2 = "Sign_Sphere200cm_F" createVehicle [0,0,0];_carcasa_coada_2 setObjectMaterialglobal [0, "a3\characters_f_bootcamp\common\data\vrarmoremmisive.rvmat"];_carcasa_coada_2 setObjectTextureGlobal [0,"modules\anomalies\AL_farty\images\shell.jpg"];
...
// efect aparitie
[[_farty_loc],"modules\anomalies\AL_farty\inout.sqf"] remoteExec ["execVM"];
sleep 1;
_farty_loc setpos (getMarkerPos _location_mark);
_farty_boss setDamage 0;
[[_cap_segment,_carcasa_coada,_farty_boss],"modules\anomalies\AL_farty\al_farty_sfx.sqf"] remoteExec ["execVM",0,true];
...
_shell_fist setObjectTextureGlobal [0,"modules\anomalies\AL_farty\01_splash.paa"];
...
[_farty_boss,_cap_segment,_carcasa_coada,_carcasa_coada_1,_carcasa_coada_2,_comp_obj_casp,_fist,_shell_fist] spawn 
{
	...
	[[_carcasa_coada_2],"modules\anomalies\AL_farty\farty_mort.sqf"] remoteExec ["execVM"];
	...
	while {alive _farty_boss} do 
	{
		...
		if (count _list_ai_in_range_fart > 0) then 
		{
				if (!isNil{_farty_boss getVariable "ascuns"}) then
				{
					...
					sleep 2;
					{_x setObjectTextureGlobal [0,"modules\anomalies\AL_farty\images\shell.jpg"];} forEach _comp_obj_casp;
					{_x setObjectTextureGlobal [0,"modules\anomalies\AL_farty\images\shell.jpg"];} forEach _fart_parts;
					};
				};
			...
			while {(_tgt_fart distance _farty_boss < 50)and(alive _tgt_fart)} do 
			{
				...
				{
					_splash_img = ["modules\anomalies\AL_farty\01_splash.paa","modules\anomalies\AL_farty\02_splash.paa"] call BIS_fnc_selectRandom;
					...
					[[_fist],"modules\anomalies\AL_farty\fist_farty.sqf"] remoteExec ["execVM"];
					...
					[[_tgt_fart],"modules\anomalies\AL_farty\damage_tgt.sqf"] remoteExec ["execVM",_tgt_fart];
					sleep 0.1;
					detach _tgt_fart;
...
} else {[_location_mark,_damage_toxic,_radius_toxic] execvm "modules\anomalies\AL_farty\ai_toxic.sqf"};