...
_strigoi addEventHandler ["Hit", {[[_this select 0],"modules\AL_strigoi\splash_hit.sqf"] remoteExec ["execvm"]}];
...
[[_strigoi],"modules\AL_strigoi\fatigue_p.sqf"] remoteExec ["execVM",0,true];
