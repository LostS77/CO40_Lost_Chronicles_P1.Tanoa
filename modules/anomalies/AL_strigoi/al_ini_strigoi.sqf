...
STRIGOI Parameters =======================
================================================================================================================================
[_marker_name,_territory,_day_activ,_inflicted_damage,_hp_strigoi] execvm "modules\AL_strigoi\strigoi.sqf"
...
["strigoi_1",500,false,0.1,30] execvm "modules\AL_strigoi\strigoi.sqf";

// ACTIVE DURING NITGHT AND DAY
["strigoi_1",300,true,0.1,50] execvm "modules\AL_strigoi\strigoi.sqf";